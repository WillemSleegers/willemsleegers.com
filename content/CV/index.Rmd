...
cv %>%
  filter(section == "Employment" & subsection == "Academic") %>%
  create_cv_section()

cv %>%
  filter(section == "Employment" & subsection == "Non-academic") %>%
  create_cv_section(include_section = FALSE)
```
