...
One of the reasons I struggle with maintaining a website is because it's hard to design a website that looks nice and has useful functionality, such as support for blogging. Of course, there's the amazing [`blogdown`](https://bookdown.org/yihui/blogdown/) package in R that makes it rather trivial to setup a website, but then you have to select a theme that fits your needs. So far, I have not found that theme, despite several getting pretty close.
...
So I've decided to build this website by going over all the code myself and changing it to be what I want it to be, using a few starters for the code and design of the website. The code mostly comes from Yihui Xie's [extremely minimal Hugo theme](https://github.com/yihui/hugo-xmin) and the design/looks comes from Jake Wiesler's [Codex theme](https://themes.gohugo.io/hugo-theme-codex/). 
