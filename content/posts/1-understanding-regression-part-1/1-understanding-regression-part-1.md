...
three different models, including our `weight = 6kg` model.
...
<img
src="../../../public/figures/1-understanding-regression-part-1/fig-three-models-1.svg"
id="fig-three-models" />
...
While a model like `weight = 6kg` is a valid model, it is not a very
...
`weight = 6kg` model, the answer is 24; out of the 25 Pokémon only
...
different models, starting with the model `weight = 1kg`, up to
`weight = 10kg`, in steps of 0.1. Ideally we would test more models (up
...
<img
src="../../../public/figures/1-understanding-regression-part-1/fig-error-sum-1.svg"
id="fig-error-sum" />
...
the case of our `weight = 6kg` model, an actual weight of 10kg would
...
<img
src="../../../public/figures/1-understanding-regression-part-1/fig-residuals-1.svg"
id="fig-residuals" />
...
each model, this time ranging from `weight = 1kg` to `weight = 100kg,`
...
<img
src="../../../public/figures/1-understanding-regression-part-1/fig-error-residuals-1.svg"
