...
description: "In this post I use the Open Data Portal of the Dutch House of Representatives to analyze the voting behavior of political parties on animal welfare issues."
date: 2022-09-24
updated: 2024-12-25
categories:
  - animal welfare
...
You can inspect the retrieved data [here](/data/motions-2021.json "2021 motions data").
...
```{r}
#| echo: false
data <- read_json("motions-2021.json")
```
...
```{r}
#| label: party-consistency-across years
voting_years |>
  group_by(party) |>
