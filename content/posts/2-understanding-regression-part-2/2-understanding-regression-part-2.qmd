...
In Part 1, I introduced a shift in perspective: instead of asking "how do I summarize this data?" I asked: **What distribution might describe this data?**

I looked at heights from adults in the !Kung San census and ran an intercept-only regression model. The model gave us an estimate (154.6 cm) and a standard error (0.64 cm). But what do these numbers mean?

I argued that we should think of statistical modeling as choosing and fitting distributions. When we run `lm(height ~ 1)`, we're proposing that heights follow a normal distribution and estimating its parameters (μ and σ).
...
Good question. Let me be clear: I'm not claiming that heights in reality follow a perfect normal distribution. No real data ever does.
