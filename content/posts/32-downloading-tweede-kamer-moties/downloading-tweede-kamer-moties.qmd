...
You can inspect the retrieved data [here](motions-2021.json "2021 motions data").
...
#| message: false
#| fig-cap: Percentage of times political parties voted 'aye' on motions related to animal welfare
#| fig-height: 7
...
#| message: false
#| fig-cap: Percentage of times a political party voted the same as the Party for the Animals
#| fig-height: 7
...
#| message: false
#| fig-cap: Times each party voted 'aye' on animal welfare motions throughout the years
#| fig-height: 7
...
#| tbl-cap: Party consistency across years
voting_years %>%
  group_by(party) %>%
