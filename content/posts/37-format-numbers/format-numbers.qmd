...
|-------------|-------------------|----------|-------------|------------------------------------------------------------------|
| 1           | 0                 | \-       | `FALSE`     | `r format_number(1, trailing_digits = 0)`                        |
| 1           | 2                 | \-       | `FALSE`     | `r format_number(1, trailing_digits = 2)`                        |
| 1           | \-                | 2        | `FALSE`     | `r format_number(1, digits = 2)`                                 |
| 1.0         | 2                 | \-       | `FALSE`     | `r format_number(1.0, trailing_digits = 2)`                      |
| 1.02        | 1                 | \-       | `FALSE`     | `r format_number(1.02, trailing_digits = 1)`                     |
| 1.02        | -                 | 1        | `FALSE`     | `r format_number(1.02, digits = 1)`                              |
| 1.02        | 2                 | \-       | `FALSE`     | `r format_number(1.02, trailing_digits = 2)`                     |
| 1.0234      | 2                 | \-       | `FALSE`     | `r format_number(1.0234, trailing_digits = 2)`                   |
| 1.00234     | 2                 | \-       | `FALSE`     | `r format_number(1.00234, trailing_digits = 2)`                  |
| 1.00020345  | 2                 | \-       | `FALSE`     | `r format_number(1.00020345, trailing_digits = 2)`               |
| 0.123       | 2                 | \-       | `TRUE`      | `r format_number(0.123, trailing_digits = 2, omit_zero = TRUE)`  |
| 0.123       | 2                 | \-       | `FALSE`     | `r format_number(0.123, trailing_digits = 2, omit_zero = FALSE)` |
| `NA`        | 2                 | \-       | `FALSE`     | `r format_number(NA, trailing_digits = 2, omit_zero = FALSE)`    |
| 1.23, 4.56  | 1                 | \-       | `FALSE`     | `r format_number(c(1.23, 4.56), trailing_digits = 1)`            |
