...
using samples drawn from our population, so let’s do that.
...
that that the bias at n = 2 is half that of the true variance,
<math>$\frac23$</math> at n = 3, <math>$\frac34$</math> at n = 4, and so
on. Interesting.
