...
ggplot(heights_prior, aes(x = height)) +
  geom_histogram(binwidth = 1, alpha = 1, fill = blue_3) +
  labs(x = "Height", y = "") +
...
ggplot(draws, aes(x = sigma, fill = distribution)) +
  geom_histogram(binwidth = 0.25, alpha = .85, position = "identity") +
  labs(
