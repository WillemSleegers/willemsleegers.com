...
In my previous [blog
post](../../../../blog/18-bayesian-tutorial-simple-regression/), I
showed how to use brms and tidybayes to run a simple regression, i.e., a
...
model <- brm(
  ...
  sample_prior = TRUE,
  seed = 4,
  file = "models/correlations-model.rds"
)
