...
description: "This is the first post in a series on understanding regression. In this first post we focus on what the main question is that we should be asking when using regression."
date: 2026-04-24
categories:
  - statistics
  - tutorial
...
The dashed line is the normal distribution we're proposing heights are drawn from. As we'll see, `lm()` estimates exactly this distribution. Its two parameters, μ and σ, are what give us the estimates, uncertainty, and predictions we're after.
