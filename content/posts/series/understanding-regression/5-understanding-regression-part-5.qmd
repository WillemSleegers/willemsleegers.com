...
That completes the estimation goal from Part 1: we have estimates of both parameters and a way to quantify the uncertainty in each. In Part 6, we turn to the second goal — hypothesis testing.